	...
	def makeWorkspace(self,iOutput,iDatas,iFuncs,iVars,iCat="cat0",iShift=True):
		...
		for pFunc in iFuncs:
			...
			if iShift and ("wqq" in process or "zqq" in process):
				...
				if (mass == 50 and int(ipt) > 3) or (mass == 250 and int(ipt) < 2): # hacked shit to get combine to work (basically 50 GeV is 1 event and combine can suck my dick)
...
if __name__ == '__main__':
	...
	parser.add_option('--input', dest='input', default = 'histInputs/hist_1DZqq-dataReRecoSpring165eff-3481-Gridv13-sig-pt5006007008009001000_msd_all.root',help='directory with data', metavar='idir')

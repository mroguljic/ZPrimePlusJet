...
python ${CMSSW_BASE}/src/ZPrimePlusJet/fitting/PbbJet/runFtest.py -o ${MAINDIR}/ --seed $1 --toys $2 --ifile ${MAINDIR}/$3 --ifile-muon ${MAINDIR}/$4 --lumi 35.9  --n 125  --freezeNuisances r_z  --setParameters r_z=1  --suffix 2016 
cd ${CWD}
mv ./ftest*/toy*.root .
mv ./ftest*/base*.root .
echo "Inside $MAINDIR:"

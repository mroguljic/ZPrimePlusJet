...
python ${CMSSW_BASE}/src/ZPrimePlusJet/fitting/PbbJet/limit.py -M GoodnessOfFit -o ${MAINDIR}/ --seed $1 --toys $2 -d ${MAINDIR}/$3  --algo KS  --lumi 35.5  --freezeNuisances r_z  --setParameters r_z=1 
cd ${CWD}
echo "Inside $MAINDIR:"
ls
echo "DELETING..."
